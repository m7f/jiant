...
class Example(BaseExample):
    ...
    def tokenize(self, tokenizer):
        return TokenizedExample(
            ...
            label_id=TerraTask.LABEL_TO_ID[self.label],
        )
...
class TerraTask(SuperGlueMixin, GlueMixin, Task):
    Example = Example
    ...
    def _create_examples(cls, lines, set_type):
        ...
        for line in lines:
            examples.append(
                Example(
                    # NOTE: TerraTask.super_glue_format_preds() is dependent on this guid format.
